...
p2<-ggplot(data = try, aes_string(x = "Age",y = "est"))+
  ...
  scale_fill_manual(values=c("#334B4A","#AF4974","#21908C"))+scale_color_manual(values=c("#334B4A","#AF4974","#21908C"))+
...
ggsave('/Users/jalbrzikowskime/Box/22q_dup_del_sMRI/results/tiledplots_CT_ASD_del.pdf',tiledplots,width=20,height=10.5)
Sys.setenv(R_GSCMD = "/usr/local/bin/gs")
embed_fonts("/Users/jalbrzikowskime/Box/22q_dup_del_sMRI/results/tiledplots_CT_ASD_del.pdf")
dev.off()

tiledplots2<-(plots[[9]] | plots[[10]] | plots[[11]] | plots[[12]])/(plots[[13]]|plots[[14]]|plots[[15]]|plots[[16]]) + plot_annotation(title="Surface Area")
ggsave('/Users/jalbrzikowskime/Box/22q_dup_del_sMRI/results/tiledplots_SA_ASD_del.pdf',tiledplots2,width=20,height=10.5)
Sys.setenv(R_GSCMD = "/usr/local/bin/gs")
embed_fonts("/Users/jalbrzikowskime/Box/22q_dup_del_sMRI/results/tiledplots_SA_ASD_del.pdf")
dev.off()