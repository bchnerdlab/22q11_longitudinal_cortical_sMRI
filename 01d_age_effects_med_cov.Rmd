...
for (i in c(1:length(brain_regions))){
  var=brain_regions[i]
  mod<-gam(adj_df[[var]]~s(Age,by=Group,k=4)+Group+SEX+s(PTID,bs="re",k=4)+EstimatedTotalIntraCranialVol.combat+Current_Any_AP,selection=TRUE,method="REML",data=adj_df)
...
write_xlsx(results_age_group_brain,path='/Users/jalbrzikowskime/Box/22q_dup_del_sMRI/results/Aim1_age_results_ap_cov.xlsx')
