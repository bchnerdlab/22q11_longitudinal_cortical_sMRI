...
for (i in c(1:length(brain_regions))){
  var=brain_regions[i]
mod<-gam(del22q[[var]]~s(Age,by=psychosis_spect2,k=4)+psychosis_spect2+SEX+SCANNER+EstimatedTotalIntraCranialVol.combat+ASD.DIAGNOS+s(PTID,bs="re"),selection=TRUE,method="REML",data=del22q)
...
write_xlsx(results_age_psychosis,path='/Users/jalbrzikowskime/Box/22q_dup_del_sMRI/results/Aim2_age_psychosis_results_ASDdx_cov.xlsx')
