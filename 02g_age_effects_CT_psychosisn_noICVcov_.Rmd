---
title: "02a_age_effects_CT_SA_psychosis"
...
#for getting Ns of psychosis spectrum/ASD comorbitity
unique<-del22q[!duplicated(del22q$PTID),]
...
brain_regions<-c("Mean_thickness.combat",
              ...
              "rh_temporal_thickness.combat","lh_parietal_thickness.combat","rh_parietal_thickness.combat","lh_occipital_thickness.combat","rh_occipital_thickness.combat")
...
for (i in c(1:length(brain_regions))){
  var=brain_regions[i]
mod<-gam(del22q[[var]]~s(Age,by=psychosis_spect2,k=4)+psychosis_spect2+SEX+SCANNER+s(PTID,bs="re"),selection=TRUE,method="REML",data=del22q)
...
write_xlsx(results_age_psychosis,path='/Users/mariajalbrzikowski/Dropbox (BCH)/22q_dup_del_sMRI/results/Aim2_age_psychosis_CT_results_noICVcov.xlsx')
